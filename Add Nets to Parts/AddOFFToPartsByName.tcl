...
# package provide capGUIUtilsOffByName 1.0
 
namespace eval ::capGUIUtilsOffByName {
    # namespace export capAddNetsToOffByNamePartEnabler
    # namespace export capAddNetsToOffByNamePart
 
    RegisterAction "Add OFF Nets To Part By Name" "::capGUIUtilsOffByName::capAddNetsToOffByNamePartEnabler" "" "::capGUIUtilsOffByName::capAddNetsToOffByNamePart" "Schematic"
}
 
proc ::capGUIUtilsOffByName::capAddNetsToOffByNamePartEnabler {} {
    set lEnableAdd 0
...
proc ::capGUIUtilsOffByName::capAddNetsToOffByNamePart {} {    
    ...
    while {$lPin != $lNullObj } { 
        ...
        ::capGUIUtilsOffByName::capAddNetToPin $lPin
...
proc ::capGUIUtilsOffByName::capAddNetToPin {lPin} {    
    set lStatus [DboState]
    set lNullObj NULL
    set lWireLength 0.5
	...
	if {$CreateLoc == "OFFPAGELEFT"} {
		PlaceOffPage $OffXloc $OffYlocUp "\\\\sng-psrvr06\\Cadence_Skills\\Pactron-tcl\\OFFPAGELEFT-L.OLB" "OFFPAGELEFT-L" $lPinName
	} elseif {$CreateLoc == "OFFPAGERIGHT"} {
		PlaceOffPage $OffXlocup $OffYlocUp "\\\\sng-psrvr06\\Cadence_Skills\\Pactron-tcl\\OFFPAGERIGHT-R.OLB" "OFFPAGERIGHT-R" $lPinName
	} else {
