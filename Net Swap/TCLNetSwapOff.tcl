...
proc NetSwapTCLOff::NetSwapTCLOfffunc {} {
    ...
    set logDir "//sng-psrvr06/Automation-Public/MiscFiles/SKILL_Logs/TCL_Logs/NetSwapTCLOff"
	...
	puts $fp "Used TCL Script  : NetSwapTCLOff"
					...
					if {$DelinpPrse2 == $DelInpNetName } {
						...
						set DelpId [$DelpOffPageConnector GetId $lStatus]
							if {$DelinpPrse1 != $DelpId } {
								...
								SetProperty {Name} {NET_NEED_TO_DELETE}
								UnSelectAll
							}
					}
				}
...
NetSwapTCLOff::NetSwapTCLOfffunc
